...
my $STAT = {
    ...
    "Term.Block"             => [ "STerm(TBlock(SmBlockT",                     \(\&StatList) ],
    ...
    "Term.If"                => [ "STerm(TIf(SmIfT",                           \(\&Term),     \(\&Term),     \(\&Term), \(\&ModList) ],
...
my $TERM = {
    ...
    "Term.Block"             => [ "TBlock(SmBlockT",                     \(\&StatList) ],
    ...
    "Term.If"                => [ "TIf(SmIfT",                           \(\&Term),     \(\&Term),     \(\&Term), \(\&ModList) ],
...
my $TYPE_ = {
    ...
    "Type.Existential"      => [ "T'Existential(SmExistentialT'",         \(\&Type_),     \(\&StatList) ],
    ...
    "Type.Refine"           => [ "T'Refine(SmRefineT'",                   \(\&Type_Opt),   \(\&StatList) ],
